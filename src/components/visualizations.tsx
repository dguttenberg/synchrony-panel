...
const CONCEPT_INSIGHTS: Record<string, string> = {
  golden_door:
    "Highest discussion volume and the most genuinely contested. The Golden Door drew the strongest organic engagement across the panel, with 73% positive sentiment — meaningful pushback alongside endorsement. Partner panelists gravitated to its phased rollout and data story. Keisha Okafor passed the shareability test on this concept specifically. The friction is real: positive statements lean toward generic praise of structure rather than emotional response to the serendipity tier itself. The creative team should treat this as the strongest territory while pressure-testing whether the emotional core (golden light, celebrity moments) lands beyond the abstract.",
  ten_ten:
    "Strong consensus, healthy volume, narrow conviction. 10•10 earned the highest sentiment ratio (88% positive) with substantive engagement from both panelists and the broader ecosystem (retailer accounts, media observers, competitor accounts all reacted). The hour-by-hour structure registered as a coherent appointment-programming concept. But look at the language: panelists endorsed 10•10 in identical terms — 'transparent,' 'structured,' 'genuine value at each phase.' That repetition signals approval of the concept's logic more than emotional pull. No panelist said they would attend, share, or change behavior because of 10•10. This is a concept the panel respects, not one they want.",
  rescue:
    "Lower volume, mixed engagement. The Rescue earned moderate discussion but did not generate the broad organic conversation the other two concepts attracted. Engagement skewed toward partner panelists evaluating its commercial mechanics (cross-network bundling, intent data) rather than consumer panelists responding to its emotional 'lives interrupted' framing. Margaret Chen and Denise Washington — the panel's emotional anchors — were notably quieter on this concept. Either the theatrical IRL installations didn't translate without visual reference, or the framing felt closer to programmed empathy than authentic recognition. Worth a deeper test before scoping budget.",
};
